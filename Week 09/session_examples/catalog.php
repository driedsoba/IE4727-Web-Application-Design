<?php //catalog.php
// start a new session / restores variables registered in existing session
session_start();
if (!isset($_SESSION['cart'])){
	$_SESSION['cart'] = array();
}

// on detecting GET['buy'] add item to $_SESSION['cart'] 
// reload current pahge with $_SERVER['PHP_SELF']
if (isset($_GET['buy'])) {
